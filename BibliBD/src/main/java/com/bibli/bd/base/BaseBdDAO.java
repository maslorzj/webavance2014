 ...
 */
public abstract class BaseBdDAO extends com.bibli.bd.dao._RootDAO {

	public static BdDAO instance;

	/**
	 * Return a singleton of the DAO
	 */
	public static BdDAO getInstance () {
		if (null == instance) instance = new BdDAO();
		return instance;
	}
	 ...
	 * @param bd a transient instance containing new or updated state 
	 */
	public void saveOrUpdate(com.bibli.bd.Bd bd)
		throws net.sf.hibernate.HibernateException {
		super.saveOrUpdate(bd);
	}
	 ...
	 * @param s the Session.
	 */
	public void saveOrUpdate(com.bibli.bd.Bd bd, Session s)
		throws net.sf.hibernate.HibernateException {
		super.saveOrUpdate(bd, s);
	}

	/**
	 * Update the persistent state associated with the given identifier. An exception is thrown if there is a persistent
	 * instance with the same identifier in the current session.
	 * @param bd a transient instance containing updated state
	 */
	public void update(com.bibli.bd.Bd bd) 
		throws net.sf.hibernate.HibernateException {
		super.update(bd);
	}
	 ...
	 * @param the Session
	 */
	public void update(com.bibli.bd.Bd bd, Session s)
		throws net.sf.hibernate.HibernateException {
		super.update(bd, s);
	}
	 ...
	 * Remove a persistent instance from the datastore. The argument may be an instance associated with the receiving
	 * Session or a transient instance with an identifier associated with existing persistent state. 
	 * @param bd the instance to be removed
	 */
	public void delete(com.bibli.bd.Bd bd)
		throws net.sf.hibernate.HibernateException {
		super.delete(bd);
	}
	 ...
	 * @param s the Session
	 */
	public void delete(com.bibli.bd.Bd bd, Session s)
		throws net.sf.hibernate.HibernateException {
		super.delete(bd, s);
	}
	 ...
	 * </ul>
	 */
	public void refresh (com.bibli.bd.Bd bd, Session s)
		throws net.sf.hibernate.HibernateException {
		super.refresh(bd, s);
	}
